  ...
  return (
    <div>
      <Navbar className="navbar" variant="dark">
        <Navbar.Brand href="/"><span className="text-danger">O</span>nline <span class="text-primary">P</span>lagiarism <span class="text-warning">C</span>hecker</Navbar.Brand>
        ...
        <Nav className="m-auto text-white">
          <NavDropdown title={user && user.regno}>
