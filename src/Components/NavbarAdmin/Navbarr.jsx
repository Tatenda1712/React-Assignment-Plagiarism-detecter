    ...
    <div>
      <Navbar className="navbar" variant="dark">
        ...
        <Nav className="m-auto">
          ...
          <Link to="/whatsadmin" className="nav-link">What is <span class="text-danger">O</span>nline <span class="text-primary">P</span>lagiarism <span class="text-warning">C</span>hecker?</Link>
